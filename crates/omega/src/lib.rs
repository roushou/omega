...
pub use omega_derive::{
    Command, Config, Effects, Form, Input, Output, PluginState, Reaction, Surface,
};
...
pub mod internal {
    ...
    pub use omega_proto::omega::{CommandDependency, CommandField, CommandType};
